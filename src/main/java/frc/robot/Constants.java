...
public final class Constants {
  ...
  public static final class AlgaeScorerConstants {
    ...
    public static final Angle PIVOT_INTAKE_ANGLE = Degrees.of(-55);

    public static double INTAKE_SPEED_PERCENT = 0.4;
